...
/// This structure describes a new proposal message.
#[cw_serde]
pub struct NewProposalMessage {
    /// Execution message
    pub msg: CosmosMsg,
}
...
pub struct NewProposal {
    ...
    /// Proposal messages
    pub messages: Option<Vec<NewProposalMessage>>,
...
#[test]
fn test_proposals_deserialization() {
    let mut app = mock_app();
    ...
    // Create valid proposal submission with order
                ...
                messages: Some(vec![
                    ProposalMessage {
                        ...
                        msg: CosmosMsg::Wasm(WasmMsg::Execute {
                            ...
                            msg: to_binary(&ExecuteMsg::CastVote {
                                proposal_id: 0,
    ...
    // try query and deserialization data as an old structure
    ...
    // try query and deserialization data as a new structure
    app.wrap()
        .query_wasm_smart::<NewProposal>(
            assembly_addr.clone(),
            &QueryMsg::Proposal { proposal_id: 1 },
        )
        .unwrap();
