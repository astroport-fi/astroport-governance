...
fn exact_simulation() {
    let case = (
        ...
        ["pxof"],
        [
            (3, "plwbbplocqyjoc", ExtendLock(8.964665476034803)),
            (1, "plwbbplocqyjoc", CreateLock(1.0, 3024000)),
            (1, "plwbbplocqyjoc", CreateLock(1.0, 0)),
        ],
        [(3, "plwbbplocqyjoc", Vote(vec![("pxof".to_string(), 10000)]))],
    );
